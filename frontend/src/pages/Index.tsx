    ...
    <div className="min-h-screen bg-dashboard-bg">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center space-y-6 mb-12">
          ...
          Real-time temperature monitoring dashboard backed by RadixIoT FastAPI Backend with WebSocket data feeds and historical analysis using data generated by UMX201
          </p>
        ...
        <Card className="dashboard-card">
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <strong className="text-dashboard-text-primary">REST API:</strong>
                <code className="block mt-1 p-2 bg-background/50 rounded text-dashboard-text-secondary font-mono">
